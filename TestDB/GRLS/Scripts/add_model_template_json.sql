...
DECLARE @json	COMMON.json = '
	{
		"base_attribs": 
		{
			"sobriquet":		"LILOO",
		 	"hot_quotient":		8,
			"yob":				1999,
			"comment":			"Dusky oriental babe - semi-pend globes with tiny highly perts - nice mons.",
			"thumbnail":		"https://www.kindgirls.com/girlsp/liloo.jpg"
		},
		"model_names": [
			{ "model_name": "Liloo",	"principal_name": 1 }
		],
		"model_flags": [
			{ "flag_abbrev": "NPPIERCE" }
		],
		"attribs": [
			{
			...
			{
				"abbrev": "NPSH", "standout_factor": 1.3, "options": [
					{ "l2_desc": "Flat",				"selected": 0 },
