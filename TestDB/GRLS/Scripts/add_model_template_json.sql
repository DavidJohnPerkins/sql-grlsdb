...
DECLARE @json	COMMON.json = '
	{
		...
		"model_names": [
			{ "model_name": "Nimfa",	"principal_name": 1 },
			{ "model_name": "Niki",	"principal_name": 0 },
			{ "model_name": "Sophia",	"principal_name": 0 },
			{ "model_name": "Cindy Y",	"principal_name": 0 },
			{ "model_name": "Nimfa Sofia",	"principal_name": 0 }
		],
		"attribs": [
			{
