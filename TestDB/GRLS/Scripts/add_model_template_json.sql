...
DECLARE @json	COMMON.json = '
	{
		...
		"model_names": [
			{ "model_name": "Colette",			"principal_name": 1 },
			{ "model_name": "Kari K",			"principal_name": 0 },
			{ "model_name": "Isabele N",		"principal_name": 0 },
			{ "model_name": "Roberta Berti",	"principal_name": 0 }
		],
		"attribs": [
			{
				"abbrev": "ASHP", "options": [
