...
DECLARE @json	COMMON.json = '
	{
		"base_attribs": 
		{
			"sobriquet":		"LILLA_KATTEN",
		 	"hot_quotient":		10,
			"yob":				2000
		},
		"model_names": [
			{ "model_name": "Lilla Katten",	"principal_name": 1 }
		],
		"model_flags": [
		],
		"attribs": [
			{
				"abbrev": "ASHP", "standout_factor": 1.1, "options": [
			...
			{
				"abbrev": "ATTR", "standout_factor": 1.0, "options": [
					...
					{ "l2_desc": "Girl-Next-Door",		"selected": 1 },
			...
			{
				"abbrev": "BRSH", "standout_factor": 1.3, "options": [
			...
			{
				"abbrev": "EYES", "standout_factor": 1.0, "options": [
			...
			{
				"abbrev": "MONS", "standout_factor": 1.3, "options": [
			...
			{
				"abbrev": "NPSZ", "standout_factor": 1.2, "options": [
					{ "l2_desc": "Tiny",				"selected": 1 },
					{ "l2_desc": "Small",				"selected": 0 },
			...
			{
				"abbrev": "PUAT", "standout_factor": 1.3, "options": [
...
DECLARE @flags_json COMMON.json = (
	SELECT 
		JSON_VALUE(@json, '$.base_attribs."sobriquet"') AS 'sobriquet',
		'add' AS 'update_type',
  		JSON_QUERY(@json, '$.model_flags') AS 'model_flags' 
