...
DECLARE @json	COMMON.json = '
	{
		"base_attribs": 
		{
			"sobriquet":		"CHANEL_FENN",
		 	"hot_quotient":		9,	
			"yob":				1999,
			"comment":			"Cute blonde womanchild cum girl-next-door - juvenile cones with tiny slightly puffy slightly perts.",
			"thumbnail":		"https://www.kindgirls.com/girlsp/chanel-fenn.jpg"
		},
		"model_names": [
			{ "model_name": "Chanel Fenn",	"principal_name": 1 },
			{ "model_name": "Cali",	"principal_name": 0 },
			{ "model_name": "Sandra",	"principal_name": 0 }
		],
		"model_flags": [
		...
		"attribs": [
			...
			{
				"abbrev": "YTHF", "standout_factor": 1.2, "options": [
					{ "l2_desc": "Mid Teens",			"selected": 1 },
