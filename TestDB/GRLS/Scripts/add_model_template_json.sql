...
DECLARE @json	COMMON.json = '
	{
		"base_attribs": 
		{
			"sobriquet":		"ALISON_ANGEL2",
		 	"hot_quotient":		9,
			"yob":				1986,
			"comment":			"Slightly trashy but somehow classy American girl-next-door blonde - large breasts and good PUAT.",
			"thumbnail":		"https://www.kindgirls.com/girlsp/alison-angel.jpg"
		},
		"model_names": [
			{ "model_name": "Alison Angel2",	"principal_name": 1 },
			{ "model_name": "Alison",	"principal_name": 0 }
		],
		"model_flags": [
		...
		"attribs": [
			...
			},
			{
				"abbrev": "BRSH", "standout_factor": 1.2, "options": [
					...
					{ "l2_desc": "Full",					"selected": 1 },
					{ "l2_desc": "Pendulous",				"selected": 0 }
				]
			},
			{
				"abbrev": "BSIZ", "standout_factor": 1.0, "options": [
					{ "l2_desc": "Flat",				"selected": 0 },
			...
			{
				"abbrev": "NPPF", "standout_factor": 1.0, "options": [
