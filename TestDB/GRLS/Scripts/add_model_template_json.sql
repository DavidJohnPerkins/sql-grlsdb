...
DECLARE @json	COMMON.json = '
	{
		"base_attribs": 
		{
			"sobriquet":		"FRANCESCA_B",
		 	"hot_quotient":		9,
			"yob":				0,
			"comment":			"Sultry, amazing eyes and nipples, interesting piercings."
		},
		"model_names": [
			{ "model_name": "Francesca B",	"principal_name": 1 }
		],
		"model_flags": [
			{"flag_abbrev":	"GNPIERCE"},
		...
		"attribs": [
			...
			},
			{
				"abbrev": "MONS", "standout_factor": 1.3, "options": [
					...
					{ "l2_desc": "Flat / Retreating",		"selected": 1 },
			...
			},
			{
				"abbrev": "NATN", "standout_factor": 1.0, "options": [
					...
					{ "l2_desc": "Czech Republic",		"selected": 1 },
